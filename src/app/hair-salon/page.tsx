      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button className="purple-gradient text-white hover:opacity-90 transition-opacity shadow-lg shadow-purple-300/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'Header', page_name: 'Hair_Salon' }); } onOpenForm(); }}>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-b border-purple-100 shadow-lg">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <Button className="purple-gradient text-white w-full" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'Header', page_name: 'Hair_Salon' }); } setMobileOpen(false); onOpenForm(); }}>
                Get Started
              </Button>
            </div>
          </div>
            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'Hero', page_name: 'Hair_Salon' }); } onOpenForm(); }}
                >
            ...
            <FadeIn key={pos.title} delay={0.1}>
              ...
              >
                <div className={idx % 2 === 1 ? 'lg:order-2' : ''}>
                  ...
                  <Button className="mt-8 purple-gradient text-white hover:opacity-90 shadow-lg shadow-purple-200/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'Services', page_name: 'Hair_Salon' }); } onOpenForm(); }}>
              ...
              >
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'Pricing', page_name: 'Hair_Salon' }); } onOpenForm(); }}
                  >
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'CTA', page_name: 'Hair_Salon' }); } onOpenForm(); }}
                  >
        ...
        <FadeIn delay={0.4}>
          <div className="mt-12 text-center">
            ...
            <Button
              ...
              onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'GetStartedClick', { button_location: 'FAQ', page_name: 'Hair_Salon' }); } onOpenForm(); }}
            >
              <Mail className="w-5 h-5 mr-2" />
              Contact Our Team
            </Button>

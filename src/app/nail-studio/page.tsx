      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button className="purple-gradient text-white hover:opacity-90 transition-opacity shadow-lg shadow-purple-300/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Header', page_name: 'Nail_Studio' }); } onOpenForm(); }}>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-b border-purple-100 shadow-lg">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <Button className="purple-gradient text-white w-full" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Header', page_name: 'Nail_Studio' }); } setMobileOpen(false); onOpenForm(); }}>
                Get Started
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <FadeIn>
              <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100 px-4 py-1.5 text-sm font-medium">
                ...
                AI-Powered Nail Studio Automation
              </Badge>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                The $12B US nail salon industry loses thousands every month — 50% of walk-in inquiries are missed during peak hours while nail techs are with clients, and after-hours booking demand is skyrocketing. MassaPro captures every call, texts back instantly, and books appointments 24/7.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Hero', page_name: 'Nail_Studio' }); } onOpenForm(); }}
                >
            ...
            <FadeIn delay={0.4}>
              <div className="flex items-center gap-8 pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500">500+ nail studios trust us</span>
                </div>
...
function StatsBanner() {
  const stats = [
    { value: '$12B', label: 'Nail Salon Market', icon: DollarSign },
    { value: '50%', label: 'Walk-In Inquiries Missed', icon: Phone },
    { value: '70%', label: 'Clients Prefer Text', icon: MessageSquare },
    { value: '42%', label: 'Bookings After Hours', icon: Clock },
    { value: '<10s', label: 'AI Response Time', icon: Zap },
    { value: '55%', label: 'No-Show Recovery', icon: TrendingUp },
  ]
        ...
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-500">
              MassaPro connects seamlessly with the tools you already use — including StyleSeat, Vagaro, and Zenoti for nail studios. From calendars and CRMs to payment gateways and booking platforms, everything works together.
            </p>
          </div>
        </FadeIn>
...
function PositionsSection({ onOpenForm }: { onOpenForm: () => void }) {
  const positions = [
    {
      title: 'AI Receptionist for Nail Studios',
      description:
        'Your front-line AI that answers calls, responds to texts, and routes inquiries — 24/7. While your nail techs are mid-manicure or gel application, MassaPro captures every call and message. Never lose another booking to voicemail with an AI receptionist that understands nail services, speaks your clients\' language, and handles multiple conversations simultaneously across every channel.',
      icon: Phone,
      features: [
        'Answer every call — even during peak hours and after close',
        'Route nail art and product inquiries to the right nail technician',
        'Greet returning clients by name with their service history',
        'Capture walk-in requests and waitlist sign-ups instantly',
      ],
      image: '/nailstudio-receptionist-v3.png',
    },
    {
      title: 'AI Secretary for Nail Studios',
      description:
        'A full-featured AI secretary that manages your complex nail appointment calendar, handles multi-duration bookings, sends reminders, and processes deposits. Think of it as a dedicated assistant who understands that a full set of acrylics takes 2 hours, a gel manicure is 60 minutes, and a basic manicure is 30 minutes — and schedules accordingly without ever double-booking.',
      icon: Calendar,
      features: [
        'Manage multi-duration appointments with smart time-slot logic',
        'Send confirmations & reminders — reduce no-shows by up to 55%',
    ...
    },
    {
      ...
      description:
        'Premium full-service AI that delivers the white-glove experience your nail clients expect. Your AI Concierge provides personalized nail care consultations, proactive aftercare follow-ups, VIP loyalty management, and multi-language support — the ultimate luxury experience that turns first-time visitors into lifelong clients.',
      icon: Star,
      features: [
        'Multi-language support (5+) for diverse clientele',
        'Personalized aftercare follow-ups and nail care tips',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              Each position is a specialized AI persona designed for nail studio operations. Deploy one or combine them for complete coverage — from front desk to VIP concierge.
            </p>
          </div>
        </FadeIn>
            ...
            <FadeIn key={pos.title} delay={0.1}>
              ...
              >
                <div className={idx % 2 === 1 ? 'lg:order-2' : ''}>
                  ...
                  <Button className="mt-8 purple-gradient text-white hover:opacity-90 shadow-lg shadow-purple-200/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Services', page_name: 'Nail_Studio' }); } onOpenForm(); }}>
  ...
  const advantages = [
    {
      ...
      stat: '$8K+/month',
      description: 'Recapture missed booking revenue from the 50% of walk-in inquiries that go unanswered while your nail techs are with clients.',
      icon: DollarSign,
    },
    {
    ...
    },
    {
      ...
      stat: '42%',
      description: '42% of nail appointments are booked outside business hours. Capture them all with 24/7 AI coverage.',
      icon: Clock,
    },
    {
      title: 'No-Show Reduction',
      stat: '55%',
      description: 'Recover 55% of no-shows with automated reminders and deposit handling for premium nail services.',
      icon: TrendingUp,
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Why Nail Studios <span className="purple-gradient-text">Choose MassaPro</span>
            </h2>
            <p className="text-lg text-gray-500">
              Every missed call is a missed manicure, a missed gel appointment, a missed nail art booking. MassaPro stops the revenue leak.
            </p>
          </div>
        </FadeIn>
  ...
  const skills = [
    {
      ...
      description:
        'Full lifecycle appointment handling for nail services — from booking manicures, pedicures, and gel nails to sending reminders and follow-ups. Handles multi-duration scheduling so a 30-minute basic manicure never blocks a 2-hour acrylic full set slot. Reduce no-shows by up to 55% with automated reminders.',
      icon: Calendar,
    },
    {
      title: 'Nail Consultation & Sales',
      description:
        'AI-powered nail care consultations and service recommendations. Your AI understands the difference between dip powder and SNS, recommends the right nail treatment for each client, and upsells add-on services like nail art, chrome finishes, or paraffin treatments — turning inquiries into high-value bookings.',
      icon: Sparkles,
    },
    {
      title: 'Payment & Deposit Handling',
      description:
        'Securely process deposits for premium nail services, handle cancellation fees, send invoices, and manage billing inquiries. Require deposits for acrylic full sets and elaborate nail art to slash no-shows. Integrated with your preferred payment gateways for seamless transactions.',
      icon: CreditCard,
    },
    {
      title: 'Customer Support & FAQ',
      description:
        'Instantly answer common nail care questions about prep instructions, aftercare, pricing, service durations, and policies. &ldquo;How long do gel nails last?&rdquo; &ldquo;Can I get acrylics over a fungal infection?&rdquo; Your AI knows the answers and learns from every interaction.',
      icon: Headphones,
    },
    {
      title: 'Marketing & Follow-up',
      description:
        'Automate post-service aftercare follow-ups, review requests, seasonal promotion campaigns (holiday nail art packages, summer pedicure specials), and re-engagement sequences. Send personalized nail care tips between visits that keep clients loyal and coming back.',
      icon: Megaphone,
    },
    {
      title: 'Multi-Channel Orchestration',
      description:
        'Unify conversations across phone, SMS, WhatsApp, Instagram DMs, Telegram, and web chat. One consistent AI experience across every touchpoint your nail clients use — because 70% of them prefer texting over calling.',
      icon: Globe,
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Powerful <span className="purple-gradient-text">AI Skills</span> for Nail Studios
            </h2>
            <p className="text-lg text-gray-500">
              Each skill is purpose-built for nail studio operations. Mix and match to build the perfect AI assistant for your unique services.
            </p>
          </div>
        </FadeIn>
  ...
  const flowCategories = [
    {
      ...
      icon: Calendar,
      flows: [
        'Manicure, Pedicure & Gel Nail Appointment Booking with Smart Duration',
        'Acrylic & Nail Art Rescheduling with Prep Reminders',
        'Same-Day Availability & Waitlist for Cancellations',
        'Multi-Service Booking (Mani-Pedi + Gel + Nail Art Combo)',
        'Bridal & Group Booking Coordination with Multiple Technicians',
      ],
    },
    {
      ...
      icon: Heart,
      flows: [
        'Nail Art Consultation Intake & Service Recommendation',
        'Post-Service Aftercare Follow-up with Customized Nail Tips',
        'No-Show Recovery with Rebooking Incentives',
        'Seasonal Promotion Campaigns (Holiday Nails, Summer Pedis)',
    ...
    },
    {
      ...
      icon: Workflow,
      flows: [
        'Deposit & Cancellation Fee Processing for Premium Services',
        'New Client Lead Qualification & Nail Care Intake Forms',
        'Product Reorder & Retail Sales Follow-up',
        'Nail Technician Schedule Sync & Multi-Provider Coordination',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              Pre-built workflows designed for nail studio operations — from acrylic prep reminders to bridal party coordination. Deploy as-is or we customize for your unique services.
            </p>
          </div>
        </FadeIn>
          ...
          <div className="mt-12 rounded-2xl purple-gradient p-8 lg:p-12 text-white text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-purple-100 max-w-2xl mx-auto text-lg">
                Every flow is customized for nail studio workflows — from acrylic prep instructions to gel nail aftercare reminders, from nail art consultation intakes to bridal party scheduling. Your AI speaks your nail studio&apos;s language.
              </p>
            </div>
          </div>
        </FadeIn>
  ...
  const tiers = [
    {
      ...
      period: '/month',
      description:
        'Perfect for independent nail studios and small salons offering manicures, pedicures, and basic gel services with a single location.',
      features: [
        '1 Skill included',
        'Up to 3 Flows/Tasks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Ideal for busy nail studios with multiple technicians, premium services like acrylics, nail art, and dip powder, and higher client volume.',
      features: [
        '2 Skills included',
        'Up to 8 Flows/Tasks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Designed for multi-location nail salon chains, high-volume studios, or nail brands needing VIP concierge-level service.',
      features: [
        '3+ Skills included',
        'Unlimited Flows/Tasks',
        '10,000+ interactions/month',
        'Dedicated AI optimization team',
        'Custom integrations (StyleSeat, Vagaro, Zenoti)',
              ...
              >
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Pricing', page_name: 'Nail_Studio' }); } onOpenForm(); }}
                  >
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        "We were missing 15+ walk-in inquiries a day during peak hours — nail techs can't stop mid-gel application to answer the phone. MassaPro now captures every single call and books manicures, pedicures, and gel appointments on the spot. We recovered over $10K in the first month alone.",
      name: 'Tanya Williams',
    ...
    {
      quote:
        "Our VIP clients expect instant, personalized service. MassaPro recognizes them by name, knows their service history, and books their favorite nail treatments without any back-and-forth. It's luxury-level service at scale — our retention rate jumped from 40% to 68%.",
      name: 'Jessica Tran',
      role: 'Director, Pink Petals Studio',
      photo: '/review-nail-2.png',
    },
    {
      quote:
        "The aftercare follow-ups with customized nail care tips have been a game-changer for our acrylic clients. They feel cared for between visits, and our rebooking rate for premium nail art services went from 25% to over 55%. Best investment we've made.",
      name: 'Monique Davis',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Loved by <span className="purple-gradient-text">Nail Studio Owners</span>
            </h2>
          </div>
        </FadeIn>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="relative rounded-3xl purple-gradient overflow-hidden shadow-2xl shadow-purple-300/30">
            <div className="absolute inset-0 bg-[url('/nailstudio-hero-v3.png')] bg-cover bg-center opacity-10" />
            <div className="relative px-8 py-16 lg:px-16 lg:py-20 text-center">
              ...
              <FadeIn delay={0.1}>
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                  Stop Losing $8K+/Month
                  <br />
                  in Missed Nail Appointments
                </h2>
              </FadeIn>
              <FadeIn delay={0.2}>
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'CTA', page_name: 'Nail_Studio' }); } onOpenForm(); }}
                  >
...
function FAQSection({ onOpenForm }: { onOpenForm: () => void }) {
  ...
  const faqs = [
    {
      question: 'Can MassaPro handle nail art consultation bookings with specific technician preferences?',
      answer:
        'Absolutely. MassaPro is designed for nail studios with complex multi-technician scheduling. Our AI understands that some clients want a specific nail artist for their nail art, that acrylic full sets require a senior technician, and basic manicures can be handled by any team member. It automatically routes booking requests to the right technician based on availability, skill set, and client preferences.',
    },
    {
      question: 'How does MassaPro handle walk-in inquiries during peak hours?',
      answer:
        'When your nail techs are fully booked and can\'t answer the phone, MassaPro steps in seamlessly. It captures every walk-in inquiry by text or call, checks real-time availability across all technicians, and either books the appointment immediately or adds the client to a waitlist. When a cancellation opens up, it automatically notifies waitlisted clients in order — recovering revenue that would otherwise be lost.',
    },
    {
      question: 'Can MassaPro manage scheduling across multiple nail technicians with different specialties?',
      answer:
        'Yes — MassaPro excels at multi-technician coordination. Each technician can have their own profile with specialties (gel nails, acrylics, nail art, dip powder), service durations, and availability. The AI matches clients to the right technician based on the requested service, ensuring your senior nail artists handle complex work while junior techs take standard appointments. No more mismatched bookings.',
    },
    {
      question: 'Does MassaPro integrate with StyleSeat, Vagaro, or Zenoti?',
      answer:
        'Yes. MassaPro integrates with the most popular nail salon booking platforms including StyleSeat, Vagaro, and Zenoti. Your AI syncs appointments, reads availability, and writes bookings directly into your existing system. No double-entry, no manual syncing — everything flows seamlessly between MassaPro and your booking platform.',
    },
    {
      question: 'Can MassaPro run seasonal nail art promotions and special offers?',
      answer:
        'Definitely. Seasonal promotions are one of our most impactful features for nail studios. MassaPro can automatically launch targeted campaigns — holiday nail art packages, summer pedicure specials, Valentine\'s Day couples manicures, and more. The AI segments your client list based on service history and preferences, sends personalized offers through SMS or email, and books the appointments directly. Studios typically see a 35% boost in seasonal bookings.',
    },
    {
      question: 'How much does MassaPro cost for a nail studio, and what\'s the ROI?',
      answer:
        'Plans start at $500/month for the Basic tier. Most nail studios recover that investment within the first week — a single captured acrylic full set booking ($80+) or gel manicure ($50+) more than covers the daily cost. With an average of $8K+/month in recovered missed revenue, the ROI is substantial. We offer a free consultation to analyze your specific call volume and booking patterns so you can see the exact impact before committing.',
    },
  ]
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Nail Studio <span className="purple-gradient-text">FAQ</span>
            </h2>
            <p className="text-lg text-gray-500">
              Questions specific to nail studios. Can&apos;t find the answer you&apos;re looking for? Reach out to our team.
            </p>
          </div>
        </FadeIn>
            ...
            <Button
              ...
              onClick={() => {
                if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') {
                  (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'FAQ', page_name: 'Nail_Studio' });
                }
                onOpenForm();
              }}
            >
...
function Footer() {
  const industries = [
    ...
    { name: 'Nail Studios', href: '/nail-studio', active: true, disabled: false },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Intelligent AI receptionists and secretaries for nail studios that never want to miss a client again.
            </p>
          </div>
...
export default function NailStudioPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Footer />
      <LeadForm open={formOpen} onOpenChange={setFormOpen} prefillIndustry="Nail Studio" />
    </div>
  )
}

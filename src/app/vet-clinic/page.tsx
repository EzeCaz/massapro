            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Hero', page_name: 'Vet_Clinic' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_hero_demo'); } catch(e){} } onOpenForm(); }}
                >
              ...
              >
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Pricing', page_name: 'Vet_Clinic' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_pricing_tier'); } catch(e){} } onOpenForm(); }}
                  >
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'CTA', page_name: 'Vet_Clinic' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_cta_signup'); } catch(e){} } onOpenForm(); }}
                  >

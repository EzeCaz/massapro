      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button className="purple-gradient text-white hover:opacity-90 transition-opacity shadow-lg shadow-purple-300/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Header', page_name: 'Beauty_Shop' }); } onOpenForm(); }}>
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-b border-purple-100 shadow-lg">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <Button className="purple-gradient text-white w-full" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Header', page_name: 'Beauty_Shop' }); } setMobileOpen(false); onOpenForm(); }}>
                Get Started
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <FadeIn>
              <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-100 px-4 py-1.5 text-sm font-medium">
                ...
                AI-Powered Beauty Shop Automation
              </Badge>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                The $15B US beauty industry loses thousands every month — 55% of calls go unanswered while estheticians are with clients, and after-hours booking demand is skyrocketing. MassaPro captures every call, texts back instantly, and books appointments 24/7.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Hero', page_name: 'Beauty_Shop' }); } onOpenForm(); }}
                >
            ...
            <FadeIn delay={0.4}>
              <div className="flex items-center gap-8 pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500">500+ beauty businesses trust us</span>
                </div>
          ...
          <FadeIn delay={0.2} className="relative">
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-purple-200/50 border border-purple-100">
                <Image
                  src="/beautyshop-hero-v3.png"
                  alt="Professional AI Receptionist for Beauty Shops"
                  width={864}
                  height={1152}
...
function StatsBanner() {
  const stats = [
    { value: '$15B', label: 'US Beauty Market', icon: DollarSign },
    { value: '55%', label: 'Calls Unanswered', icon: Phone },
  ...
  return (
    <section className="py-16 purple-gradient relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('/beautyshop-interior.png')] bg-cover bg-center opacity-5" />
        ...
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-500">
              MassaPro connects seamlessly with the tools you already use — including StyleSeat, Boulevard, and Zenoti for beauty shops. From calendars and CRMs to payment gateways and booking platforms, everything works together.
            </p>
          </div>
        </FadeIn>
...
function PositionsSection({ onOpenForm }: { onOpenForm: () => void }) {
  const positions = [
    {
      title: 'AI Receptionist for Beauty Shops',
      description:
        'Your front-line AI that answers calls, responds to texts, and routes inquiries — 24/7. While your estheticians are mid-facial or waxing session, MassaPro captures every call and message. Never lose another booking to voicemail with an AI receptionist that understands beauty services, speaks your clients\' language, and handles multiple conversations simultaneously across every channel.',
      icon: Phone,
      features: [
        'Answer every call — even during peak hours and after close',
        'Route skincare and product inquiries to the right esthetician',
    ...
    },
    {
      ...
      description:
        'A full-featured AI secretary that manages your complex beauty appointment calendar, handles multi-duration bookings, sends reminders, and processes deposits. Think of it as a dedicated assistant who understands that a chemical peel takes 90 minutes, a lash set takes 2 hours, and a brow tint is 30 minutes — and schedules accordingly without ever double-booking.',
      icon: Calendar,
      features: [
    ...
    },
    {
      ...
      description:
        'Premium full-service AI that delivers the white-glove experience your beauty clients expect. Your AI Concierge provides personalized skincare consultations, proactive aftercare follow-ups, VIP loyalty management, and multi-language support — the ultimate luxury experience that turns first-time visitors into lifelong clients.',
      icon: Star,
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              Each position is a specialized AI persona designed for beauty shop operations. Deploy one or combine them for complete coverage — from front desk to VIP concierge.
            </p>
          </div>
        </FadeIn>
            ...
            <FadeIn key={pos.title} delay={0.1}>
              ...
              >
                <div className={idx % 2 === 1 ? 'lg:order-2' : ''}>
                  ...
                  <Button className="mt-8 purple-gradient text-white hover:opacity-90 shadow-lg shadow-purple-200/30" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Services', page_name: 'Beauty_Shop' }); } onOpenForm(); }}>
  ...
  const advantages = [
    {
      ...
      stat: '$15K+/month',
      description: 'Recapture missed booking revenue from the 55% of calls that go unanswered while your team is with clients.',
      icon: DollarSign,
    },
    {
    ...
    },
    {
      ...
      stat: '45%',
      description: '45% of beauty appointments are booked outside business hours. Capture them all with 24/7 AI coverage.',
      icon: Clock,
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Why Beauty Shops <span className="purple-gradient-text">Choose MassaPro</span>
            </h2>
            <p className="text-lg text-gray-500">
              Every missed call is a missed facial, a missed waxing appointment, a missed lash booking. MassaPro stops the revenue leak.
            </p>
          </div>
        </FadeIn>
  ...
  const skills = [
    {
      ...
      description:
        'Full lifecycle appointment handling for beauty services — from booking facials, waxing, and lash appointments to sending reminders and follow-ups. Handles multi-duration scheduling so a 30-minute brow tint never blocks a 2-hour lash set slot. Reduce no-shows by up to 65% with automated reminders.',
      icon: Calendar,
    },
    {
      title: 'Beauty Consultation & Sales',
      description:
        'AI-powered skincare consultations and treatment recommendations. Your AI understands the difference between a glycolic peel and a salicylic peel, recommends the right facial for each skin type, and upsells add-on treatments like brow lamination or lip blushing — turning inquiries into high-value bookings.',
      icon: Sparkles,
    },
    {
      title: 'Payment & Deposit Handling',
      description:
        'Securely process deposits for premium treatments, handle cancellation fees, send invoices, and manage billing inquiries. Require deposits for chemical peels and lash sets to slash no-shows. Integrated with your preferred payment gateways for seamless transactions.',
      icon: CreditCard,
    },
    {
      title: 'Customer Support & FAQ',
      description:
        'Instantly answer common beauty questions about prep instructions, aftercare, pricing, service durations, and policies. &ldquo;How do I prep for a chemical peel?&rdquo; &ldquo;Can I wear makeup after a facial?&rdquo; Your AI knows the answers and learns from every interaction.',
      icon: Headphones,
    },
    {
      title: 'Marketing & Follow-up',
      description:
        'Automate post-treatment aftercare follow-ups, review requests, seasonal promotion campaigns (holiday glam packages, summer skincare), and re-engagement sequences. Send personalized skincare tips between visits that keep clients loyal and coming back.',
      icon: Megaphone,
    },
    {
      title: 'Multi-Channel Orchestration',
      description:
        'Unify conversations across phone, SMS, WhatsApp, Instagram DMs, Telegram, and web chat. One consistent AI experience across every touchpoint your beauty clients use — because 75% of them prefer texting over calling.',
      icon: Globe,
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Powerful <span className="purple-gradient-text">AI Skills</span> for Beauty Shops
            </h2>
            <p className="text-lg text-gray-500">
              Each skill is purpose-built for beauty shop operations. Mix and match to build the perfect AI assistant for your unique services.
            </p>
          </div>
        </FadeIn>
...
function FlowsSection() {
  const flowCategories = [
    ...
    },
    {
      ...
      icon: Heart,
      flows: [
        'Skincare Consultation Intake & Treatment Recommendation',
        'Post-Treatment Aftercare Follow-up with Customized Tips',
        'No-Show Recovery with Rebooking Incentives',
        'Seasonal Promotion Campaigns (Holiday Glam, Summer Skin)',
    ...
    },
    {
      ...
      flows: [
        ...
        'New Client Lead Qualification & Skincare Intake Forms',
        'Product Reorder & Retail Sales Follow-up',
        'Esthetician Schedule Sync & Multi-Provider Coordination',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              Pre-built workflows designed for beauty shop operations — from chemical peel prep reminders to bridal party coordination. Deploy as-is or we customize for your unique services.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.3}>
          <div className="mt-12 rounded-2xl purple-gradient p-8 lg:p-12 text-white text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold mb-4">Built for Beauty Shops</h3>
              <p className="text-purple-100 max-w-2xl mx-auto text-lg">
                Every flow is customized for beauty shop workflows — from chemical peel prep instructions to lash aftercare reminders, from facial consultation intakes to bridal party scheduling. Your AI speaks your beauty shop&apos;s language.
              </p>
            </div>
          </div>
        </FadeIn>
  ...
  const tiers = [
    {
      ...
      period: '/month',
      description:
        'Perfect for independent beauty shops and small studios offering facials, waxing, and brows with a single location.',
      features: [
        '1 Skill included',
        'Up to 3 Flows/Tasks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Ideal for busy beauty shops with multiple estheticians, premium treatments like chemical peels and lash extensions, and higher client volume.',
      features: [
        '2 Skills included',
        'Up to 8 Flows/Tasks',
    ...
    },
    {
      ...
      features: [
        ...
        'Custom integrations (StyleSeat, Boulevard, Zenoti)',
              ...
              >
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Pricing', page_name: 'Beauty_Shop' }); } onOpenForm(); }}
                  >
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        "We were missing 12+ calls a day during peak hours — estheticians can't stop mid-facial to answer the phone. MassaPro now captures every single call and books facials, waxing, and lash appointments on the spot. We recovered over $18K in the first month alone.",
      name: 'Olivia Grant',
    ...
    {
      quote:
        "Our VIP clients expect instant, personalized service. MassaPro recognizes them by name, knows their service history, and books their favorite treatments without any back-and-forth. It's luxury-level service at scale — our retention rate jumped from 45% to 72%.",
    ...
    {
      quote:
        "The aftercare follow-ups with customized skincare tips have been a game-changer for our chemical peel clients. They feel cared for between visits, and our rebooking rate for premium treatments went from 30% to over 60%. Best investment we've made.",
      name: 'Hannah Brooks',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Loved by <span className="purple-gradient-text">Beauty Shop Owners</span>
            </h2>
          </div>
        </FadeIn>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="relative rounded-3xl purple-gradient overflow-hidden shadow-2xl shadow-purple-300/30">
            <div className="absolute inset-0 bg-[url('/beautyshop-hero-v3.png')] bg-cover bg-center opacity-10" />
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'CTA', page_name: 'Beauty_Shop' }); } onOpenForm(); }}
                  >
...
function FAQSection({ onOpenForm }: { onOpenForm: () => void }) {
  ...
  const faqs = [
    {
      question: 'Can MassaPro handle appointments with different durations — like a 30-minute brow tint vs. a 2-hour lash set?',
      answer:
        'Absolutely. MassaPro is designed for beauty shops with complex multi-duration scheduling. Our AI understands that a chemical peel needs 90 minutes, a full lash set requires 2 hours, and a brow tint is only 30 minutes. It automatically finds the right time slots, prevents double-booking, and even handles back-to-back multi-service appointments like a facial plus brow lamination combo.',
    },
    {
      question: 'Does the AI actually understand skincare treatments enough to consult with clients?',
      answer:
        'Yes — MassaPro is trained on beauty-specific knowledge. It can explain the difference between glycolic and salicylic peels, recommend the right facial for acne-prone vs. mature skin, and answer pre- and post-treatment questions. For complex or medical-grade consultations, the AI gracefully collects the client\'s concerns and routes them to your esthetician for a personalized consultation.',
    },
    {
      question: 'How does MassaPro handle chemical peel rescheduling with proper prep reminders?',
      answer:
        'MassaPro manages the entire chemical peel lifecycle. When a client books, it sends prep instructions (stop retinol 5 days before, avoid sun exposure). If they need to reschedule, the AI adjusts the timeline and resends prep reminders for the new date. After the treatment, it sends aftercare instructions (avoid exfoliants for 7 days, use SPF 50+) and schedules the follow-up appointment automatically.',
    },
    {
      question: 'Does MassaPro integrate with StyleSeat, Boulevard, or Zenoti?',
      answer:
        'Yes. MassaPro integrates with the most popular beauty booking platforms including StyleSeat, Boulevard, and Zenoti. Your AI syncs appointments, reads availability, and writes bookings directly into your existing system. No double-entry, no manual syncing — everything flows seamlessly between MassaPro and your booking platform.',
    },
    {
      question: 'Can MassaPro send aftercare follow-ups after facials and chemical peels?',
      answer:
        'Definitely. Aftercare follow-up is one of our most impactful features for beauty shops. After each treatment, MassaPro sends customized aftercare instructions — specific to the service received. A chemical peel client gets different aftercare than a facial client. The follow-up sequence includes day-1, day-3, and day-7 check-ins, skincare tips, and a rebooking prompt that typically recovers 65% of clients who would otherwise not return.',
    },
    {
      question: 'How much does MassaPro cost for a beauty shop, and what\'s the ROI?',
      answer:
        'Plans start at $500/month for the Basic tier. Most beauty shops recover that investment within the first week — a single captured chemical peel booking ($150+) or lash set ($200+) more than covers the monthly cost. With an average of $15K+/month in recovered missed revenue, the ROI is substantial. We offer a free consultation to analyze your specific call volume and booking patterns so you can see the exact impact before committing.',
    },
  ]
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-6">
              Beauty Shop <span className="purple-gradient-text">FAQ</span>
            </h2>
            <p className="text-lg text-gray-500">
              Questions specific to beauty shops. Can&apos;t find the answer you&apos;re looking for? Reach out to our team.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.4}>
          <div className="mt-12 text-center">
            ...
            <Button
              ...
              onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'FAQ', page_name: 'Beauty_Shop' }); } onOpenForm(); }}
            >
              <Mail className="w-5 h-5 mr-2" />
              Contact Our Team
            </Button>
...
function Footer() {
  const industries = [
    ...
    { name: 'Beauty Shops', href: '/beauty-shop', active: true, disabled: false },
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Intelligent AI receptionists and secretaries for beauty shops that never want to miss a client again.
            </p>
          </div>
...
export default function BeautyShopPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Footer />
      <LeadForm open={formOpen} onOpenChange={setFormOpen} prefillIndustry="Beauty Shop" />
    </div>
  )
}

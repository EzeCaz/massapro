        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-b border-purple-100 shadow-lg">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              <Button className="purple-gradient text-white w-full" onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Header', page_name: 'Beauty_Shop' }); } setMobileOpen(false); if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_nav_contact'); } catch(e){} } onOpenForm(); }}>
                Get Started
              </Button>
            </div>
          </div>
            ...
            <FadeIn delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Hero', page_name: 'Beauty_Shop' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_hero_demo'); } catch(e){} } onOpenForm(); }}
                >
              ...
              >
                ...
                <CardFooter>
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'Pricing', page_name: 'Beauty_Shop' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_pricing_tier'); } catch(e){} } onOpenForm(); }}
                  >
              ...
              <FadeIn delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    ...
                    onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'CTA', page_name: 'Beauty_Shop' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_cta_signup'); } catch(e){} } onOpenForm(); }}
                  >
        ...
        <FadeIn delay={0.4}>
          <div className="mt-12 text-center">
            ...
            <Button
              ...
              onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).fbq === 'function') { (window as any).fbq('trackCustom', 'FreeConsultClick', { button_location: 'FAQ', page_name: 'Beauty_Shop' }); } if (typeof window !== 'undefined' && typeof (window as any).MassaProAffiliate === 'object') { try { (window as any).MassaProAffiliate.trackEvent('btn_cta_signup'); } catch(e){} } onOpenForm(); }}
            >
              <Mail className="w-5 h-5 mr-2" />
              Contact Our Team
            </Button>
